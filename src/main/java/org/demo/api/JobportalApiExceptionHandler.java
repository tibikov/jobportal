...
public class JobportalApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleConstraintViolation(ConstraintViolationException constrException,
			WebRequest request) {
	...
	protected ResponseEntity<Object> handleInvalidApiKey(JobportalInvalidApikeyException invalidApiKeyException,
			WebRequest request) {
